...
#include "MedicalVentilator_1a62e0cc_1_ds_iassert.h"
...
int32_T MedicalVentilator_1a62e0cc_1_ds_iassert(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t41, NeDsMethodOutput *out)
{
  ETTSf3049b48 t5;
  real_T t31[1];
  real_T t40[1];
