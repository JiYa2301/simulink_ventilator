 ...
 *
 * File: MedicalVentilator.h
 *
 * Code generated for Simulink model 'MedicalVentilator'.
 *
 * Model version                  : 11.4
 * Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
 * C/C++ source code generated on : Thu Jul 25 20:45:52 2024
 *
...
#ifndef MedicalVentilator_h_
#define MedicalVentilator_h_
#ifndef MedicalVentilator_COMMON_INCLUDES_
#define MedicalVentilator_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "nesl_rtw.h"
#endif                                 /* MedicalVentilator_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  real_T MedicalVentilatorLungsT_I[190];/* '<S21>/STATE_1' */
} X;
...
typedef struct {
  ...
  boolean_T MedicalVentilatorLungsT_I[190];/* '<S21>/STATE_1' */
} XDis;
...
extern void MedicalVentilator_initialize(void);
extern void MedicalVentilator_step(void);
 ...
 *
 * '<Root>' : 'MedicalVentilator'
 * '<S1>'   : 'MedicalVentilator/Check Valve 1'
 * '<S2>'   : 'MedicalVentilator/Check Valve 2'
 * '<S3>'   : 'MedicalVentilator/Control Signal'
 * '<S4>'   : 'MedicalVentilator/Humidifier'
 * '<S5>'   : 'MedicalVentilator/Sensors'
 * '<S6>'   : 'MedicalVentilator/Solver Configuration'
 * '<S7>'   : 'MedicalVentilator/Volume Data'
 * '<S8>'   : 'MedicalVentilator/Check Valve 1/Delay'
 * '<S9>'   : 'MedicalVentilator/Check Valve 2/Delay'
 * '<S10>'  : 'MedicalVentilator/Control Signal/Simulink-PS Converter'
 * '<S11>'  : 'MedicalVentilator/Control Signal/Simulink-PS Converter1'
 * '<S12>'  : 'MedicalVentilator/Control Signal/Simulink-PS Converter/EVAL_KEY'
 * '<S13>'  : 'MedicalVentilator/Control Signal/Simulink-PS Converter1/EVAL_KEY'
 * '<S14>'  : 'MedicalVentilator/Humidifier/Approximate Evaporation Formula'
 * '<S15>'  : 'MedicalVentilator/Humidifier/Simulink-PS Converter'
 * '<S16>'  : 'MedicalVentilator/Humidifier/Simulink-PS Converter/EVAL_KEY'
 * '<S17>'  : 'MedicalVentilator/Sensors/PS-Simulink Converter'
 * '<S18>'  : 'MedicalVentilator/Sensors/PS-Simulink Converter1'
 * '<S19>'  : 'MedicalVentilator/Sensors/PS-Simulink Converter/EVAL_KEY'
 * '<S20>'  : 'MedicalVentilator/Sensors/PS-Simulink Converter1/EVAL_KEY'
 * '<S21>'  : 'MedicalVentilator/Solver Configuration/EVAL_KEY'
 * '<S22>'  : 'MedicalVentilator/Volume Data/PS-Simulink Converter'
 * '<S23>'  : 'MedicalVentilator/Volume Data/PS-Simulink Converter/EVAL_KEY'
 */
#endif                                 /* MedicalVentilator_h_ */
